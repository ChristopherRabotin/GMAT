...
traj                           = Trajectory();
traj.pathFunctionName          = 'HyperSensitivePathFunctionMultiPhase_HS';   
traj.plotFunctionName          = 'HyperSensitivePlotFunctionMultiPhase_HS'; 
traj.showPlot                  = true();
...
phase1.meshIntervalFractions   = [ 0 .3 1];
...
phase2.meshIntervalFractions   = [ 0 .7 1];
phase2.meshIntervalNumPoints   = [10 10]';
