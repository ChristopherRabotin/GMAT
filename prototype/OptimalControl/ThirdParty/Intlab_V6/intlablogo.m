...
function addtext(screensaver)
  if screensaver
    ...
    text(-.42,-5.2,'The Matlab toolbox for Reliable Computing  -  www.ti3.tu-harburg.de/rump', ...
      'Fontsize',10, ...
      'FontName','Arial', ...
      'HorizontalAlignment','left');
    ...
    text(-1,-4  ,['INTLAB  -  INTerval LABoratory (Version ' intvalinit('version',0) ')'], ...
      ...
      'FontName','MS Reference Sans Serif', ...
      'HorizontalAlignment','left');
    text(-.1,-5.2,'The Matlab toolbox for Reliable Computing  -  www.ti3.tu-harburg.de/rump', ...
      'Fontsize',10, ...
      'FontName','Arial', ...
      'HorizontalAlignment','left');
