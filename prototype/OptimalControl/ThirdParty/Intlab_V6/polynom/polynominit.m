...
%
  ...
  switch lower(param)
    ...
    case 'init'
      global INTLAB_POLYNOM_DISPLAY
      INTLAB_POLYNOM_DISPLAY = 0;           % sparse display of univariate polynomials
      global INTLAB_POLYNOM_UEVAL
      INTLAB_POLYNOM_UEVAL = 1;             % Evaluation of univariate polynomials by Horner's scheme
      global INTLAB_POLYNOM_MEVAL
      INTLAB_POLYNOM_MEVAL = 0;             % Evaluation of multivariate polynomials by sums of scaled powers
      global INTLAB_POLYNOM_ACCESS_VARIABLE
      INTLAB_POLYNOM_ACCESS_VARIABLE = 1;   % Access to variable a polynomial does not depend on executed but with warning
      return
    ...
    case 'accessvariableauto'
      global INTLAB_POLYNOM_ACCESS_VARIABLE
      INTLAB_POLYNOM_ACCESS_VARIABLE = 0;
      if see
    ...
    case 'accessvariablewarn'
      global INTLAB_POLYNOM_ACCESS_VARIABLE
      INTLAB_POLYNOM_ACCESS_VARIABLE = 1;
      if see
    ...
    case 'accessvariableerror'
      global INTLAB_POLYNOM_ACCESS_VARIABLE
      INTLAB_POLYNOM_ACCESS_VARIABLE = 2;
      if see
