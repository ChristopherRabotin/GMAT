...
BEGIN Element
	Name		Astrogator Values-Target Vector-Incoming_Asymptote_RA
	IsIndepVar		No
	IndepVarName		Time
	Title		Incoming_Asymptote_RA
	NameInTitle		Yes
	Service		Astrogator
	Type		Target Vector
	Element		Incoming_Asymptote_RA
	Format		%.14e
	SumAllowedMask		1559
	SummaryOnly		No
	DataType		0
...
BEGIN Element
	Name		Astrogator Values-Target Vector-Incoming_Asymptote_Dec
	IsIndepVar		No
	IndepVarName		Time
	Title		Incoming_Asymptote_Dec
	NameInTitle		Yes
	Service		Astrogator
	Type		Target Vector
	Element		Incoming_Asymptote_Dec
	Format		%.14e
	SumAllowedMask		1559
	SummaryOnly		No
	DataType		0
...
BEGIN Element
	Name		Astrogator Values-Target Vector-Incoming_Vel_Az_at_Periapsis
	IsIndepVar		No
	IndepVarName		Time
	Title		Incoming_Vel_Az_at_Periapsis
	NameInTitle		Yes
	Service		Astrogator
	Type		Target Vector
	Element		Incoming_Vel_Az_at_Periapsis
	Format		%.14e
	SumAllowedMask		1559
	SummaryOnly		No
	DataType		0
