...
Let's start by defining some notation.  In Fig.~\ref{fig:Frames}, we
...
\special{psfile= Images/Frames.eps hoffset= -230 voffset= -250
hscale=80 vscale=80} \makebox(-180,15){$\mathcal{F}_{i}$}
\makebox(200,210){$\mathcal{F}_{f}$}
\makebox(-370,340){$\mathbf{r}_{i}$}
\makebox(-300,230){$\mathbf{r}_{if}$}
\makebox(-180,430){$\mathbf{r}_{f}$} \makebox(-250,590){o}
\end{picture}}
...
\begin{figure*}[htb]
 \centerline{
\begin{picture}(100,340)
\special{psfile= Images/RotSequence.eps hoffset= -230 voffset= -160
hscale=80 vscale=80}\makebox(-205,315){$\mathcal{F}_i$}
\makebox(300,295){$\mathcal{F}_f$}
\makebox(-90,410){$\mathcal{F}_2$}
\makebox(-390,220){$\mathcal{J}_{2k}$}
\makebox(-780,460){$\mathcal{F}_1$}
\makebox(-690,580){$\mathbf{r}_{i}$}
\makebox(-490,560){$\mathbf{r}_{f}$}
\makebox(-750,290){$\mathbf{r}_{Ri}$}
\makebox(-480,290){$\mathbf{r}_{fR}$}
...
\begin{figure}[htb]
    \begin{picture}(100,300)
       \special{psfile= Images/FK5FigOne.ps hoffset= -100 voffset=
       -100
       hscale=70 vscale=70}
    \end{picture}
