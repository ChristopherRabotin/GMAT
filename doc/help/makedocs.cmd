...
start /b contrib\fop\fop.cmd build\help-letter.fo build\help-letter-fo.pdf
echo --------------------
echo.
...
start /b contrib\fop\fop.cmd build\help-a4.fo build\help-a4-fo.pdf
echo --------------------
echo.
