   ...
   Factory           (Gmat::TRACKING_DATA)
{
   ...
   GmatType::RegisterType(Gmat::TRACKING_DATA, "TrackingData");
}
...
//------------------------------------------------------------------------------
/**
 * @see CreateTrackingData()
 */
//------------------------------------------------------------------------------
GmatBase* TrackingDataFactory::CreateObject(
         const std::string &ofType, const std::string &withName)
{
   return CreateTrackingData(ofType, withName);
}
