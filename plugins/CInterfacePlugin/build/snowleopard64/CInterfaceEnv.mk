...
GMAT_BIN_LOCATION = ../../../application/bin64
...
SPICE_INCLUDE = -I$(SPICE_DIR)/cspice64/include
SPICE_LIB_DIR = $(SPICE_DIR)/cspice64/lib
...
SHARED_LIB_FLAGS = -dylib -dynamiclib -two_levelnamespace -undefined dynamic_lookup -fPIC
...
ifeq ($(DEBUG_BUILD), 1)
OPTIMIZATIONS = -fno-strict-aliasing -fno-rtti $(WX_28_DEFINES) -fPIC
else
OPTIMIZATIONS = -O3 -fno-strict-aliasing -fno-rtti $(WX_28_DEFINES) -fPIC
endif
