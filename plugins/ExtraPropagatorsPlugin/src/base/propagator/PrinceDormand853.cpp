...
void PrinceDormand853::SetCoefficients()
{
    ...
    // An experiment
    ee[0] = 0.01312004499419480000     - cj[0];
    ee[1] =  0.0;
    ee[2] =  0.0;
    ee[3] =  0.0;
    ee[4] =  0.0;
    ee[5] = -1.22515644637620000000    - cj[5];
    ee[6] = -0.49575894965725000000    - cj[6];
    ee[7] = 1.66437718245498000000     - cj[7];
    ee[8] = -0.35032884874997300000    - cj[8];
    ee[9] = 0.33417911871301700000     - cj[9];
    ee[10] = 0.08192320648511570000    - cj[10];
    ee[11] = -0.02235530786388620000   - cj[11];
