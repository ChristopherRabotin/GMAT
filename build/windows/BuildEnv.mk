...
GMAT_ICON_DIR = C:/Projects/GmatDevelopment/src/gui/resource
...
# wxWidgets-3.0 includes STL editor
ifeq ($(USE_STC_EDITOR), 1)
STC_CPP_FLAGS = -D__USE_STC_EDITOR__ -I/C:/wxWidgets-3.0.2/include
STC_LIBRARIES = -LC:/wxWidgets-3.0.2/gcc-build/lib -lwx_mswu_stc-3.0
else
STC_CPP_FLAGS =
STC_LIBRARIES =
endif
...
# -ffriend-injection no longer used (2014.01.08)
