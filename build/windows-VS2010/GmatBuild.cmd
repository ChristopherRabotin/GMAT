...
c:\msys\bin\sh.exe -c "make clean"
rem c:\msys\bin\sh.exe -c "make clean > GmatClean.log 2> GmatClean.err"
...
c:\msys\bin\sh.exe -c "make all"
rem c:\msys\bin\sh.exe -c "make all > GmatBuild.log 2> GmatBuild.err"
IF ERRORLEVEL 2 GOTO BuildError
IF ERRORLEVEL 0 echo      Compilation was successful

echo    * Creating user docs (%time%)...
c:\msys\bin\sh.exe -c "make userdocs"
rem c:\msys\bin\sh.exe -c "make userdocs > GmatUserDocs.log 2> GmatUserDocs.err"
...
rem c:\msys\bin\sh.exe -c "make devdocs > GmatDevDocs.log 2> GmatDevDocs.err"
c:\msys\bin\sh.exe -c "make devdocs "
...
c:\msys\bin\sh.exe -c "make dist"
rem c:\msys\bin\sh.exe -c "make dist > GmatDist.log 2> GmatDist.err"
...
c:\msys\bin\sh.exe -c "make dist-devdocs"
rem c:\msys\bin\sh.exe -c "make dist-devdocs > GmatDistDevDocs.log 2> GmatDistDevDocs.err"
