...
C          
C        TO TURN ON AND OFF PARTICULAR VARIATIONS CALL TSELEC00(SW),
...
C
      ...
      COMMON/GTS3C00/TLB,S,DB04,DB16,DB28,DB32,DB40,DB48,DB01,ZA,
     & T0,Z0,G0,RL,DD,DB14,TR12
     ...
     & PMA(100,10),SAM(100)
      ...
      DATA SV/25*1./
      IF(ISW.NE.64999) CALL TSELEC00(SV)
...
C      ***** N2 DENSITY ****
        DMR=DS(3)/DM28M-1.
        D(3)=DENSM00(ALT,DM28M,XMM,TZ,MN3,ZN3,TN3,TGN3,MN2,ZN2,TN2,TGN2)
        D(3)=D(3)*(1.+DMR*DMC)
C      ***** HE DENSITY ****
        D(1)=0
...
C
   ...
   10 CONTINUE
      GOTO 90
   50 CONTINUE
      DD=DENSM00(ALT,1.,0.,TZ,MN3,ZN3,TN3,TGN3,MN2,ZN2,TN2,TGN2)                
      T(2)=TZ
   90 CONTINUE
      ALAST=ALT
      RETURN
...
C         New altitude estimate using scale height
  ...
  100 FORMAT(1X,29HGHP7 NOT CONVERGING FOR PRESS, 1PE12.2,E12.2)
      ...
      END
C-----------------------------------------------------------------------
      SUBROUTINE GLATF00(LAT,GV,REFF)
...
C      Diffusive density at Alt
      D(3)=DENSU00(Z,DB28,TINF,TLB, 28.,ALPHA(3),T(2),PTM(6),S,MN1,ZN1,
     & TN1,TGN1)
      DD=D(3)
C      Turbopause
      ZH28=PDM(3,3)*ZHF
...
C      Mixed density at Zlb
      B28=DENSU00(ZH28,DB28,TINF,TLB,XMD,ALPHA(3)-1.,TZ,PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      IF(Z.GT.ALTL(3).OR.SW(15).EQ.0.) GO TO 17
C      Mixed density at Alt
      DM28=DENSU00(Z,B28,TINF,TLB,XMM,ALPHA(3),TZ,PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
C      Net density at Alt
      D(3)=DNET00(D(3),DM28,ZHM28,XMM,28.)
   17 CONTINUE
...
C      Diffusive density at Alt
      D(1)=DENSU00(Z,DB04,TINF,TLB, 4.,ALPHA(1),T(2),PTM(6),S,MN1,ZN1,
     & TN1,TGN1)
      DD=D(1)
...
C      Turbopause
      ZH04=PDM(3,1)
C      Mixed density at Zlb
      B04=DENSU00(ZH04,DB04,TINF,TLB,4.-XMM,ALPHA(1)-1.,
     &  T(2),PTM(6),S,MN1,ZN1,TN1,TGN1)
C      Mixed density at Alt
      DM04=DENSU00(Z,B04,TINF,TLB,XMM,0.,T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      ZHM04=ZHM28
C      Net density at Alt
      D(1)=DNET00(D(1),DM04,ZHM04,XMM,4.)
...
C       Diffusive density at Alt
      D(2)=DENSU00(Z,DB16,TINF,TLB, 16.,ALPHA(2),T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      DD=D(2)
...
C       Turbopause
      ZH16=PDM(3,2)
C      Mixed density at Zlb
      B16=DENSU00(ZH16,DB16,TINF,TLB,16-XMM,ALPHA(2)-1.,
     &  T(2),PTM(6),S,MN1,ZN1,TN1,TGN1)
C      Mixed density at Alt
      DM16=DENSU00(Z,B16,TINF,TLB,XMM,0.,T(2),PTM(6),S,MN1,ZN1,
     & TN1,TGN1)
      ZHM16=ZHM28
C      Net density at Alt
      D(2)=DNET00(D(2),DM16,ZHM16,XMM,16.)
...
C      Net density corrected at Alt
      D(2)=D(2)*CCOR00(Z,RC16,HCC16,ZCC16)
   34 CONTINUE
...
C       Diffusive density at Alt
      D(4)=DENSU00(Z,DB32,TINF,TLB, 32.,ALPHA(4),T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      IF(MASS.EQ.49) THEN
         DD=DD+2.*D(4)
      ELSE
...
C       Turbopause
      ZH32=PDM(3,4)
C      Mixed density at Zlb
      B32=DENSU00(ZH32,DB32,TINF,TLB,32.-XMM,ALPHA(4)-1.,
     &  T(2),PTM(6),S,MN1,ZN1,TN1,TGN1)
C      Mixed density at Alt
      DM32=DENSU00(Z,B32,TINF,TLB,XMM,0.,T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      ZHM32=ZHM28
C      Net density at Alt
      D(4)=DNET00(D(4),DM32,ZHM32,XMM,32.)
C       Correction to specified mixing ratio at ground
      RL=ALOG(B28*PDM(2,4)/B32)
      HC32=PDM(6,4)*PDL(8,2)
      ZC32=PDM(5,4)*PDL(7,2)
      D(4)=D(4)*CCOR00(Z,RL,HC32,ZC32)
   38 CONTINUE
...
C       Diffusive density at Alt
      D(5)=DENSU00(Z,DB40,TINF,TLB, 40.,ALPHA(5),T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      DD=D(5)
...
C       Turbopause
      ZH40=PDM(3,5)
C      Mixed density at Zlb
      B40=DENSU00(ZH40,DB40,TINF,TLB,40.-XMM,ALPHA(5)-1.,
     &  T(2),PTM(6),S,MN1,ZN1,TN1,TGN1)
C      Mixed density at Alt
      DM40=DENSU00(Z,B40,TINF,TLB,XMM,0.,T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      ZHM40=ZHM28
C      Net density at Alt
      D(5)=DNET00(D(5),DM40,ZHM40,XMM,40.)
C       Correction to specified mixing ratio at ground
      RL=ALOG(B28*PDM(2,5)/B40)
      HC40=PDM(6,5)*PDL(10,2)
      ZC40=PDM(5,5)*PDL(9,2)
C      Net density corrected at Alt
      D(5)=D(5)*CCOR00(Z,RL,HC40,ZC40)
   44 CONTINUE
      IF(MASS.NE.48)   GO TO 90
   45 CONTINUE
C
...
C       Diffusive density at Alt
      D(7)=DENSU00(Z,DB01,TINF,TLB,1.,ALPHA(7),T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      DD=D(7)
...
C       Turbopause
      ZH01=PDM(3,6)
C      Mixed density at Zlb
      B01=DENSU00(ZH01,DB01,TINF,TLB,1.-XMM,ALPHA(7)-1.,
     &  T(2),PTM(6),S,MN1,ZN1,TN1,TGN1)
C      Mixed density at Alt
      DM01=DENSU00(Z,B01,TINF,TLB,XMM,0.,T(2),PTM(6),S,MN1,ZN1,
     & TN1,TGN1)
      ZHM01=ZHM28
C      Net density at Alt
      D(7)=DNET00(D(7),DM01,ZHM01,XMM,1.)
C       Correction to specified mixing ratio at ground
      RL=ALOG(B28*PDM(2,6)*ABS(PDL(18,2))/B01)
      HC01=PDM(6,6)*PDL(12,2)
      ZC01=PDM(5,6)*PDL(11,2)
      D(7)=D(7)*CCOR00(Z,RL,HC01,ZC01)
C       Chemistry correction
      HCC01=PDM(8,6)*PDL(20,2)
      ZCC01=PDM(7,6)*PDL(19,2)
      RC01=PDM(4,6)*PDL(21,2)
C      Net density corrected at Alt
      D(7)=D(7)*CCOR00(Z,RC01,HCC01,ZCC01)
   47 CONTINUE
      IF(MASS.NE.48)   GO TO 90
   48 CONTINUE
C
...
C       Diffusive density at Alt
      D(8)=DENSU00(Z,DB14,TINF,TLB,14.,ALPHA(8),T(2),PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      DD=D(8)
...
C       Turbopause
      ZH14=PDM(3,7)
C      Mixed density at Zlb
      B14=DENSU00(ZH14,DB14,TINF,TLB,14.-XMM,ALPHA(8)-1.,
     &  T(2),PTM(6),S,MN1,ZN1,TN1,TGN1)
C      Mixed density at Alt
      DM14=DENSU00(Z,B14,TINF,TLB,XMM,0.,T(2),PTM(6),S,MN1,ZN1,TN1,TGN1)
      ZHM14=ZHM28
C      Net density at Alt
      D(8)=DNET00(D(8),DM14,ZHM14,XMM,14.)
C       Correction to specified mixing ratio at ground
      RL=ALOG(B28*PDM(2,7)*ABS(PDL(3,1))/B14)
      HC14=PDM(6,7)*PDL(2,1)
      ZC14=PDM(5,7)*PDL(1,1)
      D(8)=D(8)*CCOR00(Z,RL,HC14,ZC14)
C       Chemistry correction
      HCC14=PDM(8,7)*PDL(5,1)
      ZCC14=PDM(7,7)*PDL(4,1)
      RC14=PDM(4,7)*PDL(6,1)
C      Net density corrected at Alt
      D(8)=D(8)*CCOR00(Z,RC14,HCC14,ZCC14)
   49 CONTINUE
      IF(MASS.NE.48) GO TO 90
   46 CONTINUE
C
...
C
      ...
      DD=DENSU00(Z,DB16H,THO,THO,16.,ALPHA(9),T2,PTM(6),S,MN1,
     & ZN1,TN1,TGN1)
      ZSHT=PDM(6,8)
      ZMHO=PDM(5,8)
...
C       TEMPERATURE AT ALTITUDE
   50 CONTINUE
      Z=ABS(ALT)
      DDUM  = DENSU00(Z,1., TINF,TLB,0.,0.,T(2),PTM(6),S,
     & MN1,ZN1,TN1,TGN1)
   90 CONTINUE
...
C  PARMS NOT USED: 83, 90,100,140-150
   ...
   50 TINF = TINF + ABS(SW(I))*T(I)
      ...
      END
C-----------------------------------------------------------------------
      SUBROUTINE TSELEC00(SV)
C        SET SWITCHES
C        Output in  COMMON/CSW/SW(25),ISW,SWC(25)
C        SW FOR MAIN TERMS, SWC FOR CROSS TERMS
C  
C        TO TURN ON AND OFF PARTICULAR VARIATIONS CALL TSELEC00(SV),
...
C        LONGITUDINAL
   ...
   50 TT=TT+ABS(SW(I))*T(I)
      ...
      END
C--------------------------------------------------------------------
      FUNCTION DENSU00(ALT,DLB,TINF,TLB,XM,ALPHA,TZ,ZLB,S2,
     &  MN1,ZN1,TN1,TGN1)
...
C       Calculate spline coefficients
      CALL SPLINE00(XS,YS,MN,YD1,YD2,Y2OUT)
      X=ZG/ZGDIF
      CALL SPLINT00(XS,YS,Y2OUT,MN,X,Y)
C       temperature at altitude
      TZ=1./Y
      DENSU00=TZ
...
C       integrate spline temperatures
      CALL SPLINI00(XS,YS,Y2OUT,MN,X,YI)
      EXPL=GAMM*YI
      IF(EXPL.GT.50..OR.TZ.LE.0.) THEN
        EXPL=50.
      ENDIF
C       Density at altitude
      DENSU00=DENSU00*(T1/TZ)**(1.+ALPHA)*EXP(-EXPL)
   50 CONTINUE
      RETURN
      END
C--------------------------------------------------------------------
      FUNCTION DENSM00(ALT,D0,XM,TZ,MN3,ZN3,TN3,TGN3,MN2,ZN2,TN2,TGN2)
...
C       Density at altitude
      DENSM00=DENSM00*(T1/TZ)*EXP(-EXPL)
   20 CONTINUE
...
C        Density at altitude
   ...
   30 CONTINUE
   50 CONTINUE
      IF(XM.EQ.0) DENSM00=TZ
      RETURN
      END
C-----------------------------------------------------------------------
      SUBROUTINE SPLINE00(X,Y,N,YP1,YPN,Y2)
...
C        Y2: OUTPUT ARRAY OF SECOND DERIVATIVES
   ...
   12 CONTINUE
      ...
      END
C-----------------------------------------------------------------------
      SUBROUTINE SPLINT00(XA,YA,Y2A,N,X,Y)
...
C        Y: OUTPUT VALUE
    ...
    1 CONTINUE
      ...
      ENDIF
      H=XA(KHI)-XA(KLO)
      IF(H.EQ.0) WRITE(6,*) 'BAD XA INPUT TO SPLINT00'
      A=(XA(KHI)-X)/H
      B=(X-XA(KLO))/H
      Y=A*YA(KLO)+B*YA(KHI)+
     &  ((A*A*A-A)*Y2A(KLO)+(B*B*B-B)*Y2A(KHI))*H*H/6.
      ...
      END
C-----------------------------------------------------------------------
      SUBROUTINE SPLINI00(XA,YA,Y2A,N,X,YI)
...
C        Y: OUTPUT VALUE
    ...
    1 CONTINUE
     ...
     &     (B2*B2/4.-B2/2.)*Y2A(KHI))*H*H/6.)*H
      ...
      END
C-----------------------------------------------------------------------
      FUNCTION DNET00(DD,DM,ZHM,XMM,XM)
...
C          DNET00 - combined density
      SAVE
      A=ZHM/(XMM-XM)
      IF(DM.GT.0.AND.DD.GT.0) GOTO 5
        WRITE(6,*) 'DNET00 LOG ERROR',DM,DD,XM
