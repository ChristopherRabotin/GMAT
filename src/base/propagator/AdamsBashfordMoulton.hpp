...
//------------------------------------------------------------------------------
// *** File Name : AdamsBashfordMoulton.hpp
...
#ifndef AdamsBashfordMoulton_H
#define AdamsBashfordMoulton_H
...
class GMAT_API AdamsBashfordMoulton :
    public PredictorCorrector
{
public:
//    AdamsBashfordMoulton(void);
    AdamsBashfordMoulton(const std::string &nomme);

    virtual ~AdamsBashfordMoulton(void);

    AdamsBashfordMoulton(const AdamsBashfordMoulton& abm);
