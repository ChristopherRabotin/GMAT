...
//  waw: 04/19/04
//    ss = solarmodel::SolarData::Instance();
//    if (!ss) 
//    {
//        initialized = false;
//        return false;
...
//    solarmodel::SSBody *bod = ss->GetBody(bodyID);
...
//
//      sunDistance = bod->meanSun;
//
//      cbSunVector[0] = sunDistance * cos(ra) * sin(dec);
//      cbSunVector[1] = sunDistance * sin(ra) * sin(dec);
//      cbSunVector[2] = sunDistance * cos(dec);
//   }
//    else
//        cbSunVector = ss->GetBody(solarmodel::SUN)->PositionRelative(bodyID);
...
//      cbSunVector = new Real[3];
//
//      sunDistance = bod->meanSun; waw: 04/19/04
//
//      cbSunVector[0] = sunDistance * cos(ra) * sin(dec);
//      cbSunVector[1] = sunDistance * sin(ra) * sin(dec);
//      cbSunVector[2] = sunDistance * cos(dec);
