...
Rvector6 OrbitData::GetIncAsymState()
{
   ...
   // Call GetCartState() to convert to parameter coord system first
   Rvector6 state = GetCartState();
   Rvector6 mIncAsymState = StateConversionUtil::Convert(state, "Cartesian", "IncomingAsymptote",
                                                         mGravConst, mFlattening, mEqRadius);
   
   return mIncAsymState;
}
...
Rvector6 OrbitData::GetOutAsymState()
{
   ...
   // Call GetCartState() to convert to parameter coord system first
   Rvector6 state = GetCartState();
   Rvector6 mOutAsymState = StateConversionUtil::Convert(state, "Cartesian", "OutgoingAsymptote",
                                                         mGravConst, mFlattening, mEqRadius);
   
   return mOutAsymState;
}
...
Rvector6 OrbitData::GetBLshortState()
{
   ...
   // Call GetCartState() to convert to parameter coord system first
   Rvector6 state = GetCartState();
   Rvector6 mBLshortState = StateConversionUtil::Convert(state, "Cartesian", "BrouwerMeanShort",
                                                         mGravConst, mFlattening, mEqRadius);
   
   return mBLshortState;
}
...
Rvector6 OrbitData::GetBLlongState()
{
   ...
   // Call GetCartState() to convert to parameter coord system first
   Rvector6 state = GetCartState();
   Rvector6 mBLlongState = StateConversionUtil::Convert(state, "Cartesian", "BrouwerMeanLong",
                                                        mGravConst, mFlattening, mEqRadius);
