...
void GmatMainFrame::RemoveChild(const wxString &item, GmatTree::ItemType itemType)
{
   ...
   while (node)
   {
          ...
          (theChild->GetItemType() == itemType))
      {
         ...
         {
            #ifdef DEBUG_REMOVE_CHILD
            MessageInterface::ShowMessage("   ==> deleting this child\n");
            #endif
            delete theChild;
         }
