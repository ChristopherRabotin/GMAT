...
//        wxT("High Accuracy Analytic")
    ...
    item4 = new wxListBox( parent, ID_LISTBOX, wxDefaultPosition, wxSize(140,125), 3, strs4, wxLB_SINGLE );
    ...
    item7 = new wxButton( parent, ID_BUTTON_SORT, wxT("Prioritize"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    item11 = new wxListBox( parent, ID_LISTBOX, wxDefaultPosition, wxSize(140,125), 0, strs11, wxLB_SINGLE );
