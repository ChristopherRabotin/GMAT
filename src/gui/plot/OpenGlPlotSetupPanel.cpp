...

{
   ...
   mViewUpAxisComboBox =
      ...
      new wxComboBox(this, ID_COMBOBOX, wxT(""), wxDefaultPosition, wxSize(120,-1), 6, axisArray, wxCB_DROPDOWN);
   ...
   MessageInterface::ShowMessage("OpenGlPlotSetupPanel::Create() Adding objects to sizers for Mac\n");
   ...
   MessageInterface::ShowMessage("OpenGlPlotSetupPanel::Create() Adding objects to sizers for Windows\n");
   ...
   MessageInterface::ShowMessage("OpenGlPlotSetupPanel::Create() Exiting sizers for Windows\n");
