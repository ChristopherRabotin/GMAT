...
//--------------------------------------------------------------------
std::string Surface::MakeSurfaceName (const Integer& ix)
...
//--------------------------------------------------------------------
Integer ZChildArray::Add (Surface* x)
...
//--------------------------------------------------------------------
const Surface* ZChildArray::operator[] (const Integer& ix) const
...
//--------------------------------------------------------------------
Surface* ZChildArray::operator[] (const Integer& ix) 
...
//--------------------------------------------------------------------
void SurfaceGroup::AddChild (Surface* child)
