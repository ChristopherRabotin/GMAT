...
BEGIN_EVENT_TABLE(BurnSetupPanel, wxPanel)
    EVT_COMBOBOX(ID_CB_VECTOR, BurnSetupPanel::OnVectorChange)
    EVT_COMBOBOX(ID_CB_COORDINATE, BurnSetupPanel::OnVectorChange)
    EVT_BUTTON(ID_BUTTON_OK, BurnSetupPanel::OnOK)
    EVT_BUTTON(ID_BUTTON_APPLY, BurnSetupPanel::OnApply)
    EVT_BUTTON(ID_BUTTON_CANCEL, BurnSetupPanel::OnCancel)
    EVT_BUTTON(ID_BUTTON_SCRIPT, BurnSetupPanel::OnScript)
END_EVENT_TABLE()
...
//------------------------------------------------------------------------------
// BurnSetupPanel(wxWindow *parent)
//------------------------------------------------------------------------------
/**
 * Constructs BurnSetupPanel object.
 *
 * @param <parent> input parent.
 *
 * @note Creates the burn dialog box
 */
//------------------------------------------------------------------------------
BurnSetupPanel::BurnSetupPanel(wxWindow *parent, const wxString &burnName)
    :wxPanel(parent)
{
...
//------------------------------------------------------------------------------
// void CreateBurn(wxWindow *parent)
//------------------------------------------------------------------------------
/**
 * @param <parent> input parent.
 *
 ...
 */
//------------------------------------------------------------------------------
void BurnSetupPanel::CreateBurn(wxWindow *parent, const wxString &burnName)
{
 ...
 */
//------------------------------------------------------------------------------
void BurnSetupPanel::CreateFinite(wxWindow *parent)
{
 ...
 */
//------------------------------------------------------------------------------
void BurnSetupPanel::AddVector(wxWindow *parent)
{
 ...
 */
//------------------------------------------------------------------------------
void BurnSetupPanel::CartesianVector()
{
 ...
 */
//------------------------------------------------------------------------------
void BurnSetupPanel::SphericalVector()
{
 ...
 */
//------------------------------------------------------------------------------
void BurnSetupPanel::UpdateValues()
{
    // Coordinate Frame
...
//    theBurn->SetStringParameter(el, "LaMont");
 ...
 */
//------------------------------------------------------------------------------
/*void BurnSetupPanel::OnFormatChange()
{
 ...
 */
//------------------------------------------------------------------------------
void BurnSetupPanel::OnVectorChange()
{
    Integer id;
