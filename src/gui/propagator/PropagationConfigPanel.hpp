...
#ifndef PropagationConfig_hpp
#define PropagationConfig_hpp
...
class PropagationConfig : public wxPanel
{
public:
	// constructors
	PropagationConfig(wxWindow *parent);
